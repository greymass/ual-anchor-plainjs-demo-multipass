...
class App extends Component {
  ...
  addAccount = () => {
    this.props.ual.loginUser(this.props.ual.authenticators[0])
  }
      ...
      >
        <Header attached="top" block size="huge">
          ...
          <Header.Subheader>
            ...
            <p>Source code: <a href="https://github.com/greymass/ual-anchor-plainjs-demo-multipass">https://github.com/greymass/ual-anchor-plainjs-demo-multipass</a></p>
          </Header.Subheader>
        </Header>
